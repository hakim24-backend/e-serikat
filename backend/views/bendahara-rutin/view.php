    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'label'=>'Nilai Uang Muka Anggaran Sekretariat',
                'visible' => ($Role == "Bendahara") ? true : false
            ],
            [
                'attribute'=>'activityDailyBudgetSecretariatsOne.budget_value_sum',
                'label'=>'Nilai Uang Total Anggaran Sekretariat',
                'visible' => ($Role == "Bendahara") ? true : false
            ],
            // [
            //     'attribute'=>'activityDailyBudgetSecretariatsOne.budget_value_dp',
            ...
            [
                ...
                'label'=>'Nilai Uang Muka Anggaran Seksi',
                'visible' => ($Role == "Bendahara") ? true : false
            ],
            [
                'attribute'=>'activityDailyBudgetSectionsOne.budget_value_sum',
                'label'=>'Nilai Uang Total Anggaran Seksi',
                'visible' => ($Role == "Bendahara") ? true : false
            ],
            [
                'attribute'=>'title',
