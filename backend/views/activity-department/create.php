              ...
              <div class="col-sm-12">
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                          ...
                          <?= Html::dropDownList('jenis_sdm_source', null , [7 => 'Departemen'], ['prompt' => 'Pilih Jenis SDM', 'class'=>'col-sm-8', 'id'=>'jenis-asal']) ?>
                          <?php } ?>
                      </div>
                  </div>
              </div>
  ...
  <div class="box-body">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?= Html::textInput('wakil', '', ['autofocus' => true, 'required'=>false, 'type'=>'text','class'=>'col-sm-8 form-control', 'id'=>'judul']) ?>
            </div>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?= Html::textInput('sekretaris', '', ['autofocus' => true, 'required'=>false, 'type'=>'text','class'=>'col-sm-8 form-control', 'id'=>'judul']) ?>
            </div>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?= Html::textInput('bendahara', '', ['autofocus' => true, 'required'=>false, 'type'=>'text','class'=>'col-sm-8 form-control', 'id'=>'judul']) ?>
            </div>
        </div>
    </div>
  </div>
