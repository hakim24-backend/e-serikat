...
/**
 * This is the model class for table "activity_daily_budget_secretariat".
 *
 * @property int $id
 ...
 */
class ActivityDailyBudgetSecretariat extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'activity_daily_budget_secretariat';
    }
